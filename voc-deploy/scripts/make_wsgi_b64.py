...
print(f"原文长度: {len(index_html)} 字符")
print(f"UTF-8 长度: {len(index_bytes)} 字节")
print(f"Base64 长度: {len(index_b64)} 字符")
...
with open('c:/Users/xmls/Documents/trae_projects/ppt-master/voc-deploy/scripts/wsgi_b64.py', 'w', encoding='utf-8') as f:
    f.write(WSGI_CODE)
