...
<body>
    ...
    <footer class="footer">
        ...
        <p class="footer-copy">PPT Master © 2025–2026 · Made by <a href="https://www.hehugo.com/" target="_blank" style="color: var(--primary-light); text-decoration: none;">Hugo He</a></p>
    </footer>
    ...
    <script>
        ...
        const projects = [
            ...
            },
            {
                ...
                tags: ['Dark Theme', 'AI Safety', 'Anthropic'],
                isNew: true,
                cover: '01_cover.svg'
            },
            {
            ...
            },
            {
                ...
                style: 'general',
                styleName: '暗色奢华战术风',
                desc: '亚马逊美国站休闲工装战术服装市场深度分析，从市场规模、竞争格局到产品设计DNA的全方位专业解读。',
                tags: ['战术服装', '电商市场', '亚马逊', '户外装备'],
                isNew: true,
                cover: 'P01_封面.svg'
            },
            {
