...
1. Go to [github.com/xiajta-rgb/ppt-master](https://github.com/xiajta-rgb/ppt-master)
...
- 📖 [FAQ](./faq.md)
- 🐛 [GitHub Issues](https://github.com/xiajta-rgb/ppt-master/issues) — include your Python version, Windows version, and full error message
- 💬 [GitHub Discussions](https://github.com/xiajta-rgb/ppt-master/discussions)
